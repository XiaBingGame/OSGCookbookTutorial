...
int main(int argc, char** argv)
{
	...
	root->addChild(createMatrixTransform(geode1, osg::Vec3(-2.0, 0.0, 0.0)));
	root->addChild(createMatrixTransform(geode2, osg::Vec3(0.0, 0.0, 0.0)));
	root->addChild(createMatrixTransform(geode3, osg::Vec3(2.0, 0.0, 0.0)));
